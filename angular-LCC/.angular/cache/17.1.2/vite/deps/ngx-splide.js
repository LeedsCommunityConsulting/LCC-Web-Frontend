...
function NgxSplideComponent_div_4_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵproperty("ngTemplateOutlet", slide_r2.slideContent);
  }
}
function NgxSplideComponent_div_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    ɵɵadvance();
    ɵɵproperty("ngIf", slide_r2.slideContent);
  }
}
...
_NgxSplideComponent.ɵcmp = ɵɵdefineComponent({
  ...
  decls: 5,
  vars: 2,
  consts: [[1, "splide", 3, "ngClass"], ["splideElement", ""], [1, "splide__track"], [1, "splide__list"], ["class", "splide__slide", 4, "ngFor", "ngForOf"], [1, "splide__slide"], [4, "ngIf"], [3, "ngTemplateOutlet"]],
